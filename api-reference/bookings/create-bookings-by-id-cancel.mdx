---
title: "POST /v1/bookings/{id}/cancel"
...
```bash cURL
curl -X POST https://www.skaala.ai/api/v1/bookings/abc123/cancel \
...
const response = await fetch('https://www.skaala.ai/api/v1/bookings/abc123/cancel', {
  method: 'POST',
  headers: {
...
response = requests.post(
    'https://www.skaala.ai/api/v1/bookings/abc123/cancel',
